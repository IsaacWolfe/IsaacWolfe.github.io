...
var Terminal = Terminal || function(cmdLineContainer, outputContainer) {
  ...
  const CMDS_ = [
    'clear', 'education', 'experience', 'help', 'involvement', 'ls', 'objective', 'skills', 'website', 'contact'
  ];
    // const SECTION_ = [
    ...
    if (e.keyCode == 9) { // tab
      ...
      switch (cmd) {
        ...
        case 'involvement':
              ...
              break;
        case 'website':
              window.location.href = 'https://isaacwolfe.github.io/resume.html';
              break;
        case 'contact':
              output("<p>Phone: (727)709-0549<br>Email: <a href='mailto:iwwolfe97@gmail.com'>iwwolfe97@gmail.com</a></p>");
              break;
        // case 'cat':
              // switch (section) {
        ...
        // case 'echo':
          ...
          // break;
        case 'help':
          output('<p>Type each command you would like to use. Enter \'ls\' followed by enter to list each part of the resume that\'s viewable, to view the section just type the section name.</p><div class="ls-files">' + CMDS_.join('<br>') + '</div>');
          break;
        // case 'uname':
        ...
        //   break;
        case 'ls':
          output('<p>Objective &nbsp Experience &nbsp Skills &nbsp Education &nbsp Involvement &nbsp Website &nbsp Contact</p>');
          break;
        default:
          if (cmd) {
